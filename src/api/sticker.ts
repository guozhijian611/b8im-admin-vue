...
const prefix = '/saimulti/admin/sticker'
...
export default {
  ...
  itemSave(params: Record<string, any>) {
    return request.post<any>({ url: `${prefix}/itemSave`, data: params })
  },
  itemUpdate(params: Record<string, any>) {
    return request.put<any>({ url: `${prefix}/itemUpdate`, data: params })
  },
