  ...
  <div class="art-full-height">
    ...
    <ElCard class="art-table-card" shadow="never">
      ...
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton v-permission="'saimulti:admin:menu:save'" @click="showDialog('add')" v-ripple>
              <template #icon>
            ...
            <ElButton
              v-permission="'saimulti:admin:menu:destroy'"
      ...
      >
        ...
        <template #operation="{ row }">
          <div class="flex justify-end gap-2">
            <SaButton
              v-permission="'saimulti:admin:menu:save'"
              v-if="row.type < 3"
              type="primary"
              @click="handleAdd(row)"
            />
            <SaButton
              v-permission="'saimulti:admin:menu:update'"
              type="secondary"
...
<script setup lang="ts">
  ...
  import api from '@/api/admin/panel/menu'
  import TableSearch from './modules/table-search.vue'
  import EditDialog from './modules/edit-dialog.vue'
  import { h } from 'vue'
  import ArtSvgIcon from '@/components/base/art-svg-icon/index.vue'
