  ...
  >
    <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
      <el-form-item label="所属机构" prop="organization">
        <el-select v-model="formData.organization">
          <el-option
            v-for="item in optionData.organData"
            :key="item.id"
            :value="item.id"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="类型" prop="user_type">
            <sa-radio v-model="formData.user_type" value-type="string" dict="user_type" />
          </el-form-item>
        </el-col>
      </el-row>
...
<script setup lang="ts">
  ...
  import organApi from '@/api/admin/panel/organization'
  ...
  const initPage = async () => {
    ...
    // 机构数据
    const organData = await organApi.list({ saiType: 'all' })
    optionData.organData = organData
