  ...
  <div class="art-full-height">
    ...
    <ElCard class="art-table-card" shadow="never">
      ...
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton v-permission="'saimulti:coreDept:save'" @click="showDialog('add')" v-ripple>
              <template #icon>
      ...
      >
        ...
        <template #operation="{ row }">
          <div class="flex gap-2">
            <SaButton
              v-permission="'saimulti:coreDept:update'"
              type="secondary"
              @click="showDialog('edit', row)"
            />
            <SaButton
              v-permission="'saimulti:coreDept:destroy'"
              type="error"
...
<script setup lang="ts">
  ...
  import api from '@/api/admin/system/dept'
