  ...
  <div class="art-full-height">
    ...
    <ElCard class="art-table-card" shadow="never">
      ...
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton v-permission="'saimulti:coreMenu:save'" @click="showDialog('add')" v-ripple>
              <template #icon>
            ...
            <ElButton
              v-permission="'saimulti:coreMenu:destroy'"
      ...
      >
        ...
        <template #operation="{ row }">
          <div class="flex justify-end gap-2">
            <SaButton
              v-permission="'saimulti:coreMenu:save'"
              v-if="row.type < 3"
              type="primary"
              @click="handleAdd(row)"
            />
            <SaButton
              v-permission="'saimulti:coreMenu:update'"
              type="secondary"
...
<script setup lang="ts">
  ...
  import api from '@/api/admin/system/menu'
