      ...
      <div class="flex flex-col flex-grow min-w-0">
        ...
        <ElCard class="flex flex-col flex-1 min-h-0 art-table-card" shadow="never">
          ...
          <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
            <template #left>
              <ElSpace wrap>
                <ElButton v-permission="'saimulti:admin:save'" @click="showDialog('add')" v-ripple>
                  <template #icon>
          ...
          >
            ...
            <template #operation="{ row }">
              <div class="flex gap-2" v-if="row.id !== 1 && userStore.info.id !== row.id">
                <SaButton
                  v-permission="'saimulti:admin:update'"
                  type="secondary"
                  @click="showDialog('edit', row)"
                />
                <SaButton
                  v-permission="'saimulti:admin:destroy'"
                  type="error"
                  ...
                  <template #dropdown>
                    <ElDropdownMenu>
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:admin:home'"
                      ...
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:admin:password'"
                      ...
                      <ElDropdownItem>
                        <div
                          class="flex-c gap-2"
                          v-permission="'saimulti:admin:cache'"
...
<script setup lang="ts">
  ...
  import api from '@/api/admin/system/user'
  import deptApi from '@/api/admin/system/dept'
