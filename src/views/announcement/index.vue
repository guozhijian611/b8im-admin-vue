    ...
    <ElCard class="art-table-card" shadow="never">
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton
              v-permission="'saimulti:admin:announcement:save'"
            ...
            <ElButton
              v-permission="'saimulti:admin:announcement:destroy'"
      ...
      >
        ...
        <template #operation="{ row }">
          <ElSpace wrap>
            <ElButton
              v-permission="'saimulti:admin:announcement:read'"
              size="small"
            ...
            <ElButton
              ...
              v-permission="'saimulti:admin:announcement:update'"
              size="small"
              type="success"
...
<script setup lang="ts">
  ...
  const canEditAnnouncement = computed(() =>
    ['saimulti:admin:announcement:read', 'saimulti:admin:announcement:update'].every(checkAuth)
  )
