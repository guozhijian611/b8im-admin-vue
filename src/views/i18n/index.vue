        ...
        <ElTabPane label="语言目录" name="locale">
          <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
            <template #left>
              <ElSpace wrap>
                <ElButton
                  v-permission="'saimulti:admin:i18n:save'"
                ...
                <ElButton
                  v-permission="'saimulti:admin:i18n:destroy'"
          ...
          >
            ...
            <template #operation="{ row }">
              <ElSpace wrap>
                <ElButton
                  v-permission="'saimulti:admin:i18n:update'"
                  size="small"
          ...
          >
            <template #left>
              <ElSpace wrap>
                ...
                <ElButton
                  v-permission="'saimulti:admin:i18n:entry'"
