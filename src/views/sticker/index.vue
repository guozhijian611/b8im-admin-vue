      ...
      <ElTabs v-model="activeTab">
        <ElTabPane label="表情包" name="pack">
          <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
            <template #left>
              <ElSpace wrap>
                <ElButton v-permission="'saimulti:admin:sticker:save'" @click="showDialog('add')">
                  新增表情包
                </ElButton>
                <ElButton
                  v-permission="'saimulti:admin:sticker:destroy'"
          ...
          >
            ...
            <template #operation="{ row }">
              <ElSpace wrap>
                <ElButton
                  v-permission="'saimulti:admin:sticker:update'"
                  size="small"
        ...
        <ElTabPane label="表情项" name="item" :disabled="!currentPackId">
          ...
          >
            <template #left>
              <ElSpace wrap>
                ...
                <ElButton v-permission="'saimulti:admin:sticker:item'" @click="showItemDialog('add')">
                  新增表情
                </ElButton>
              </ElSpace>
            </template>
          ...
          >
            ...
            <template #operation="{ row }">
              <ElSpace wrap>
                <ElButton
                  v-permission="'saimulti:admin:sticker:item'"
                  size="small"
