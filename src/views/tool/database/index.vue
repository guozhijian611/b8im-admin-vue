    ...
    <ElCard class="art-table-card" shadow="never">
      ...
      <ArtTableHeader v-model:columns="columnChecks" :loading="loading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton
              v-permission="'saimulti:database:edit'"
      ...
      >
        ...
        <template #operation="{ row }">
          <div class="flex gap-2">
            <SaButton
              v-permission="'saimulti:database:index'"
              type="primary"
              icon="ri:node-tree"
              tool-tip="表结构"
            ...
            />
            <SaButton
              v-permission="'saimulti:recycle:index'"
              type="success"
...
<script setup lang="ts">
  ...
  import api from '@/api/tool/database'
  ...
  const {
    ...
    core: {
      ...
      columnsFactory: () => [
        ...
        { prop: 'collation', label: '字符集', width: 160 },
