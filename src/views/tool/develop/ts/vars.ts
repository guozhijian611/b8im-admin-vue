export const menuList: { name: string; value: string; comment: string }[] = [
  { name: '导入', value: 'import', comment: '勾选生成导入全部功能' },
  { name: '导出', value: 'export', comment: '勾选生成导出全部功能' }
]
...
// 搜索控件
export const searchComponent: { label: string; value: string }[] = [
  { label: '输入框', value: 'input' },
  { label: '字典单选框', value: 'radio' },
  { label: '字典下拉框', value: 'saSelect' },
  { label: '日期选择器', value: 'date' },
